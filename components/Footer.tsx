...
export default function Footer() {
  const footerLinks = {
    Products: ['Gearbox', 'Differential', 'Propeller Shaft', 'Hydraulic System'],
    Support: ['Customer Area', 'Technical Support', 'Documentation', 'Warranty'],
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          {Object.entries(footerLinks).map(([category, links], index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-lg font-semibold mb-6 text-amber-400">{category}</h3>
